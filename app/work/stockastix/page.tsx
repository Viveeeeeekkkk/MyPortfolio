      ...
      <div className="flex items-center justify-center min-h-screen max-w-4xl md:mt-24 mx-auto text-gray-200">
        <div className="py-10 px-28 font-playfair text-left">
          <div id="top" className="mb-16">
            <div className="mb-4 flex justify-between"><div className="text-4xl">Stockastix</div><div className="text-lg text-right self-center"><i>~ SDE, June'24 - September'24</i></div></div>
            <Image src={stockastix} alt="stockastix" className="mt-2" />
          </div>
          ...
          <div className="flex justify-between mt-10">
            ...
            >
              <div style={{ zIndex: "1000" }} className="text-[19px] flex" onClick={() => router.push("/work/my-trade-journal")}>
